...
If you have any improvement ideas, notice a missing feature or a bug, create a GitHub issue by clicking **Issues -> New issue** in GitHub. Describe the bug or the suggested improvement in detail. Provide proper argumentation and screenshots, if necessary.
...
4. Open a pull request in GitHub. Describe the reason for the provided changes. Link your pull request with the existing issue, if applicable. After submitting your PR, wait for the review from the project maintainers.
